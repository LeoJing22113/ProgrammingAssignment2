## These funtions written in partial fulfillment of Coursera Data Science:
## R Programming Week 3 Assignment; week beginning 2, 17, 2020;
## GitHub user: LeoJing22113
